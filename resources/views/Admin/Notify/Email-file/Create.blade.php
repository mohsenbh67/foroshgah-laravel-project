...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item font-size-12"> <a href="{{ route('admin.notify.email-file.index',$email->id) }}"> فایل های ایمیل </a> </li>
      <li class="breadcrumb-item font-size-12 active" aria-current="page"> ایجاد فایل جدید </li>
    </ol>
  </nav>
