<header class="header">
    ...
    <section class="sidebar-header bg-gray">
        <section class="d-flex justify-content-between flex-md-row-reverse px-2">
            ...
            <span><img class="logo" src="{{ asset('Amin-assets/images/logo.png') }}" alt=""></span>
                            ...
                            <li class="list-group-item list-group-item-action">
                                <section class="media">
                                    ...
                                    <section class="media-body pr-1">
                                        <section class="d-flex justify-content-between">
                                            <h5 class="comment-user">محمد هاشمی</h5>
                                            <span><i class="fas fa-circle text-success comment-user-status comment-user-status"></i></span>
                                        </section>
                                    </section>
                                </section>
                            </li>
