                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control form-control-sm" name="category_id" id="category_id" >
                                    ...
                                    <option value="{{ $postCategory->id }}" @if (old('category_id',$postCategory->id) == $postCategory->id) selected @endif>{{ $postCategory->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            @error('category_id')
                        ...
                        @endphp
                            ...
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control form-control-sm" type="text" name="published_at" id="published_at" style="display: none" value="{{ old('published_at',$post->published_at) }}">
                                    <input class="form-control form-control-sm" type="text" id="published_at_view" value="{{ old('published_at',$post->published_at) }}" >
                                </div>
                                @error('published_at')
                                <span class="alert_required text-danger p-1" role="alert">
                                    <strong>
                            ...
                            <section class="col-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control form-control-sm" type="hidden" name="tags" id="tags" value="{{ old('tags',$post->tags) }}">
                            ...
                            <section class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="summary" id="summary" rows="10" class="form-control form-control-sm">{{ old('summary',$post->summary) }}</textarea>
                                </div>
                                @error('summary')
                                <span class="alert_required text-danger p-1" role="alert">
                                    <strong>
                            ...
                            <section class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="body" id="body" rows="10" class="form-control form-control-sm">{{ old('body',$post->body) }}</textarea>
                                </div>
                                @error('body')
                                <span class="alert_required text-danger p-1" role="alert">
                                    <strong>
