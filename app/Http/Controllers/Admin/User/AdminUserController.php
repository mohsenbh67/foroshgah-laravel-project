...
class AdminUserController extends Controller
{
    ...
    public function store(AdminUserRequest $request, ImageService $imageService)
    {
        ...
        if ($request->hasFile('profile_photo_path')) {
            ...
            if ($result === false) {
                return redirect()->route('admin.user.admin-user.index')->with('alert-section-error', 'آپلود تصویر با خطا مواجه شد');
            }
        ...
        return redirect()->route('admin.user.admin-user.index')->with('alert-section-success', 'ادیمن شما با موفقیت ثبت شد');
    }
    ...
    public function destroy(User $admin)
    {
        ...
        return redirect()->route('admin.user.admin-user.index')->with('alert-section-success', 'ادمین شما با موفقیت حذف شد');
    }
