...
class CustomerController extends Controller
{
    ...
    public function store(CustomerRequest $request, ImageService $imageService)
    {
        ...
        if ($request->hasFile('profile_photo_path')) {
            ...
            if ($result === false) {
                return redirect()->route('admin.user.customer.index')->with('alert-section-error', 'آپلود تصویر با خطا مواجه شد');
            }
        ...
        return redirect()->route('admin.user.customer.index')->with('alert-section-success', 'مشتری شما با موفقیت ثبت شد');
    }
    ...
    public function destroy(User $user)
    {
        ...
        return redirect()->route('admin.user.customer.index')->with('alert-section-success', 'مشتری شما با موفقیت حذف شد');
    }
