...
class PageController extends Controller
{
    ...
    public function store(PageRequest $request)
    {
        ...
        return redirect()->route('admin.content.page.index')->with('alert-section-success', 'پیج جدید شما با موفقیت ثبت شد');
    }
    ...
    public function update(PageRequest $request, Page $page)
    {
        ...
        $page ->update($inputs);
        return redirect()->route('admin.content.page.index')->with('alert-section-success', 'دپیج شما با موفقیت ویرایش شد');
    }
    ...
    {
        $result = $page->delete();
        return redirect()->route('admin.content.page.index')->with('alert-section-success', 'پیج شما با موفقیت حذف شد');
    }
