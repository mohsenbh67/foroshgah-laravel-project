...
class MenuController extends Controller
{
    ...
    public function store(MenuRequest $request)
    {
        ...
        return redirect()->route('admin.content.menu.index')->with('alert-section-success', 'منو جدید شما با موفقیت ثبت شد');
    }
    ...
    public function update(MenuRequest $request, Menu $menu)
    {
        ...
        $inputs = $request->all();
        $menu ->update($inputs);
        return redirect()->route('admin.content.menu.index')->with('alert-section-success', 'منو شما با موفقیت ویرایش شد');
    }
    ...
    {
        $result = $menu->delete();
        return redirect()->route('admin.content.menu.index')->with('alert-section-success', 'منو شما با موفقیت حذف شد');
    }
