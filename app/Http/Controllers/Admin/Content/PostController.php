...
class PostController extends Controller
{
    ...
    public function store(PostRequest $request, ImageService $imageService)
    {
        ...
        if ($request->hasFile('image')) {
            ...
            if ($result === false) {
                return redirect()->route('admin.content.post.index')->with('alert-section-error', 'آپلود تصویر با خطا مواجه شد');
            }
            $inputs['image'] = $result;
        }
        ...
        return redirect()->route('admin.content.post.index')->with('alert-section-success', 'پست جدید شما با موفقیت ثبت شد');
    }
    ...
    public function update(PostRequest $request, Post $post, ImageService $imageService)
    {
        ...
        $post->update($inputs);
        return redirect()->route('admin.content.post.index')->with('alert-section-success', 'دسته بندی شما با موفقیت ویرایش شد');
    }
    ...
    {
        $result = $post->delete();
        return redirect()->route('admin.content.post.index')->with('alert-section-success', 'دسته بندی شما با موفقیت حذف شد');
    }
