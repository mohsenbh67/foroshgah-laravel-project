...
class EmailController extends Controller
{
    ...
    public function store(EmailRequest $request)
    {
        ...
        return redirect()->route('admin.notify.email.index')->with('alert-section-success', 'ایمیل شما با موفقیت ثبت شد');
    }
    ...
    public function update(EmailRequest $request, Email $email)
    {
        ...
        $inputs['published_at'] = date("Y-m-d H:i:s", (int)$realTimestampStart);
        $email->update($inputs);
        return redirect()->route('admin.notify.email.index')->with('alert-section-success', 'ایمیل شما با موفقیت ویرایش شد');
    }
    ...
    {
        $result = $email->delete();
        return redirect()->route('admin.notify.email.index')->with('alert-section-success', 'ایمیل شما با موفقیت حذف شد');
    }
